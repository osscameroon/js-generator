...
Sometimes, we forget how to use javascript to build dynamic apps. Thus, the goal of this project is helping developers gaining time by producing javascript code as output based on html as input. This project might be very useful for beginners learning html and javascript.
